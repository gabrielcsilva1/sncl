...
local grammar = {
  lpegMatch = function(snclString)
    ...
    local lpegGrammar = {
      ...
      ReservedAction = P'start'+'stop'+'set'+'abort',
      ...
      MacroPresentationElement = V'Spc'^0* parseTree:makePresentationElement(C(V'Reserved') *V'Spc'^1 * C(V'Id') *V'Spc'^1
        *(V'MacroPresentationElement'+V'MacroPort'+V'Property'+V'MacroLink'+V'Template'+V'Spc')^0 *C(V'End'), symbolsTable, true),
      MacroLink = (V'Spc'^0*
      ...
      MacroBody = (V'MacroPresentationElement'+V'MacroLink'+V'MacroPort'+V'Template'+V'MacroCall')^0,
      ...
      Reference = (V'Alphanumerics'+P'/'+P'%'+P'@'+P'.'+P'#')^1,
